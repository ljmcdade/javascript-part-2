...
function operationMaker(operation) {
   ...
   // var subtracting = operationMaker("subtract");
   // var difference = subtracting(n1, n2);

  //  var dividing = operationMaker("divide");
  //  var remainder = dividing(n1, n2);
...
var adding = operationMaker("add");
var sum = adding(4, 6);

var multiplying = operationMaker("multiply");
var product = multiplying(5, 7);
